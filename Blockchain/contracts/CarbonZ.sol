...
contract CarbonZ is ERC20 {

    uint256 constant fixedFee = 1 ether; // annual subscription fees for service provided
    address payable public admin;

    constructor() ERC20("CarbonZ", "CoZ") {
    ...
    // different lower limit of possible carbon emission according to the compliant carbon credit market
    ...
    event registration(string indexed, uint256, address indexed);
    event fundsWithdrawn(uint, address indexed);
